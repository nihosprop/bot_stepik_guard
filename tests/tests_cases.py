...
class TestCases:
    test_cases = [
        ...
        ("Первый, кто написал про великого суповара.", False),
        ("@Мирон_Киселев, Добрый день, действительно, проверил, "
         "не повторяется. Получается не обратил внимания на раскладку "
         "клавиатуры, когда объявлял переменную. Спасибо.", False),
